...
JACK = render('{BRONTZ}', colors=['white', 'red'], align='center')
print(f'''
\033[1;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
                      {JACK}
...
ID = input('\033[1;33m -  ID : ')
print("\033[1;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
TOKEN = input('\033[1;33m - TOKEN : ')
os.system('clear')
def update_stats():
...
def check(email):
    ...
    joy = 'android-'
    device_id = joy + hashlib.md5(str(uuid.uuid4()).encode()).hexdigest()[:16]
    uui = str(uuid.uuid4())
    headers = {
...
def InfoAcc(username, domain):
    ...
    # Calculate account creation year from user_id
    acc_year = date(user_id) if user_id else "?"
    total_hits += 1
    info_text = f"""
